...
private:
    ...
    void createGraphicsPipeline() {
        std::vector<char> vertShaderCode(&demoshaders_demo_vert_spv[0], &demoshaders_demo_vert_spv[demoshaders_demo_vert_spv_len]);
        std::vector<char> fragShaderCode(&demoshaders_demo_frag_spv[0], &demoshaders_demo_frag_spv[demoshaders_demo_frag_spv_len]);
